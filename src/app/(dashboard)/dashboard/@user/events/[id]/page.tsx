...
export default function ManageEventPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto pb-24">
      ...
      {/* Tabs */}
      <div className="flex items-center gap-2 p-1.5 bg-secondary/30 border border-border/50 rounded-4xl mb-12 w-fit mx-2 backdrop-blur-sm">
        <button
          onClick={() => setActiveTab("SETTINGS")}
          className={`flex items-center gap-3 px-8 py-3.5 rounded-2xl text-xs font-black uppercase tracking-widest transition-all ${activeTab === "SETTINGS"
        ...
        <button
          ...
          className={`flex items-center gap-3 px-8 py-3.5 rounded-2xl text-xs font-black uppercase tracking-widest transition-all ${activeTab === "ATTENDEES"
            ? "bg-primary text-primary-foreground shadow-xl shadow-primary/20 scale-[1.02]"
            : "text-muted-foreground hover:bg-secondary/50"
            }`}
        >
